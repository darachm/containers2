...
RUN Rscript -e 'BiocManager::install(version="3.12","GOSemSim");'
RUN Rscript -e 'BiocManager::install(version="3.12","clusterProfiler");'
RUN Rscript -e 'BiocManager::install(version="3.12","variancePartition");'
RUN Rscript -e 'BiocManager::install(version="3.12","DESeq2");'
